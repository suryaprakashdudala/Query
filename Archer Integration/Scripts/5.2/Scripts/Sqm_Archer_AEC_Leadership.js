                ...
                let:
                    {
                        ...
                        pcaobOperationalResponsibilityGovernanceAndLeadership: { $toString: '$pcaobOperationalResponsibilityGovernanceAndLeadership' },
                        pcaobOperationalResponsibilityAcceptanceAndContinuance: { $toString: '$pcaobOperationalResponsibilityAcceptanceAndContinuance' },
                        pcaobOperationalResponsibilityEngagementPerformance: { $toString: '$pcaobOperationalResponsibilityEngagementPerformance' },
                        pcaobOperationalResponsibilityResources: { $toString: '$pcaobOperationalResponsibilityResources' },
                        pcaobOperationalResponsibilityInformationAndCommunication: { $toString: '$pcaobOperationalResponsibilityInformationAndCommunication' },
                            ...
                            $and:[
                                {
                                    $or:[
                                        ...
                                        {$eq: [ '$$pcaobOperationalResponsibilityGovernanceAndLeadership','$titleId']},
                                        {$eq: [ '$$pcaobOperationalResponsibilityAcceptanceAndContinuance','$titleId']},
                                        {$eq: [ '$$pcaobOperationalResponsibilityEngagementPerformance','$titleId']},
                                        {$eq: [ '$$pcaobOperationalResponsibilityResources','$titleId']},
                                        {$eq: [ '$$pcaobOperationalResponsibilityInformationAndCommunication','$titleId']}
                                    ]
                                },
                                {
                                    $in: [ '$fiscalYear',fiscalYearFilter]
